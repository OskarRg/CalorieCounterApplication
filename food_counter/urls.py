...
from .views import (DateListView, DateDetailView, DateCreateView, DateUpdateView, MealCreateView, DateDeleteView,
                    MealListView, MealUpdateView, MealDeleteView,
                    ProductCreateView, ProductUpdateView, ProductsListView
                    )
